...
def create_prompt_and_response(entry):
    ...
    prompt = (
        f"यहाँ एक स्थिति है जिसे विश्लेषण करने की आवश्यकता है। कहानी इस प्रकार है:\n"
        f"{story}\n\n"
        f"प्रश्न:\n"
        f"{question}\n\n"
        f"विकल्प:\n"
...
if __name__ == "__main__":
    ...
    for pair in ["AB", "BC", "CA"]:
        input_file = f"datav2/translated_responses/hi/{pair}.json"
        filename1 = pair
        filename2 = pair[::-1]
        ...
        with open(f"datav2/prompt_response/hi/train/{filename1}.json", "w", encoding="utf-8") as f:
            json.dump(prompts_jsonAB, f, indent=4, ensure_ascii=False)

        with open(f"datav2/prompt_response/hi/train/{filename2}.json", "w", encoding="utf-8") as f:
        ...
        with open(f"datav2/prompt_response/hi/test/{filename1}.json", "w", encoding="utf-8") as f:
            json.dump(prompts_jsonAB, f, indent=4, ensure_ascii=False)

        with open(f"datav2/prompt_response/hi/test/{filename2}.json", "w", encoding="utf-8") as f:
            json.dump(prompts_jsonBA, f, indent=4, ensure_ascii=False)
